var createObjects = function () {
    ...
    waterObj[19] = new gameObject(360, 250, "wood line", 2, "right", 2.5)
    waterObj[20] = new gameObject(480, 250, "wood line", 2, "right", 2.5)


    waterObj[2] = new gameObject(120, 217, "wood line", 3, "left", 2.5)
    waterObj[3] = new gameObject(240, 217, "wood line", 3, "left", 2.5)
    waterObj[21] = new gameObject(360, 217, "wood line", 3, "left", 2.5)
    waterObj[22] = new gameObject(480, 217, "wood line", 3, "left", 2.5)

    waterObj[4] = new gameObject(50, 182, "turtle1", 1, "left")
    waterObj[5] = new gameObject(80, 182, "turtle1", 1, "left")
    waterObj[6] = new gameObject(110, 182, "turtle1", 1, "left")

    waterObj[7] = new gameObject(170, 182, "turtle1", 1, "left")
    waterObj[8] = new gameObject(200, 182, "turtle1", 1, "left")
    waterObj[9] = new gameObject(230, 182, "turtle1", 1, "left")

    waterObj[10] = new gameObject(300, 182, "turtle1", 1, "left")
    waterObj[11] = new gameObject(330, 182, "turtle1", 1, "left")
    waterObj[12] = new gameObject(360, 182, "turtle1", 1, "left")

    waterObj[13] = new gameObject(100, 148, "crocodile1", 1, "right", 2.5)
    waterObj[14] = new gameObject(200, 148, "crocodile1", 1, "right", 2.5)
    waterObj[23] = new gameObject(350, 148, "wood line", 1, "right", 2.5)
    waterObj[24] = new gameObject(450, 148, "wood line", 1, "right", 2.5)

    waterObj[17] = new gameObject(120, 112, "wood line", 1, "left", 2.5)
    waterObj[18] = new gameObject(240, 112, "wood line", 1, "left", 2.5)
    waterObj[15] = new gameObject(360, 112, "wood line", 1, "left", 2.5)
    waterObj[16] = new gameObject(480, 112, "wood line", 1, "left", 2.5)
}
